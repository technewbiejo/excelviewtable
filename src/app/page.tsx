      ...
      reader.onload = async (e) => {
        try {
          ...
          if (file.type === 'text/csv' || file.name.endsWith('.csv')) {
            ...
            parsedHeaders = jsonData[0].map(String);
            ...
            // For AI analysis, convert XLSX data to a CSV string
             csvForAi = [parsedHeaders.join(','), ...parsedData.map(row => parsedHeaders.map(h => row[h]).join(','))].join('\n');
          }
